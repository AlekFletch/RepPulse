...
Обновлено: 2026-09-24 (Этап 4). Документ для продолжения работы в новом диалоге. Здесь собраны главные факты, решения и открытые вопросы. Подробности — в [01](01-platform-verification.md) … [04](04-deveco-device-setup.md), Этап 3 — в [06](06-stage3.md), Этап 4 — в [07](07-stage4.md).
...
### 5.1. Ограничения lite, найденные на Этапах 3–4 (держать в голове при любых правках)
...
| `storage.get` может не вызвать колбэк | экран «зависает» в ожидании | таймаут 1,5 с в `LocalStorageAdapter`; старт тренировки не ждёт хранилище |
| Значение в `storage` ≤ 128 символов | запись падает с 202 | настройки — по ключу на поле |
